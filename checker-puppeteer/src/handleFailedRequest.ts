...
import { ActorCheckDetailedOutput } from './typedefs.js';

export async function handleFailedRequest(state: ActorCheckDetailedOutput, { request }: PuppeteerCrawlingContext) {
